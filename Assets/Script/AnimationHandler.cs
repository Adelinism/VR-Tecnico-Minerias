...
public class AnimationHandler
{
    ...
    {
        CustomAnimationUtility.UpdateAnimationProgress(animator, layer, fwdAnim, backAnim, ref fwdAnimTime, ref backAnimTime);
    }
    ...
    public void MoveForward()
    {
        ...
        CustomAnimationUtility.ChangeAnimatorState(animator, fwdAnim, layer, fwdAnimTime);
    }

    public void MoveBackward()
    {
        animator.SetFloat(LAYER_SPEED_MULT_TEMPLATE + layer, 1);
        CustomAnimationUtility.ChangeAnimatorState(animator, backAnim, layer, backAnimTime);
    }
