...
public class WheelLoaderControllerV1_1 : MonoBehaviour
{
    ...
    void Arm_Move()
    {
        ...
        CustomAnimationUtility.UpdateAnimationProgress(Arm_Animator, 0, ANIMS_ARM_UP, ANIMS_ARM_DOWN, ref Arm_AnimationTime_Up, ref Arm_AnimationTime_Down);
        CustomAnimationUtility.UpdateAnimationProgress(Bucket_Animator, 0, ANIMS_BUCKET_UP, ANIMS_BUCKET_DOWN, ref Bucket_AnimationTime_Up, ref Bucket_AnimationTime_Down); 
