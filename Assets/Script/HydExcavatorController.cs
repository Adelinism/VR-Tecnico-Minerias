...
public class HydExcavatorController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        CustomAnimationUtility.UpdateAnimationProgress(
        ...
        if (Input.GetKey(KeyCode.W))
        {
            ...
            CustomAnimationUtility.ChangeAnimatorState(animator, ANIMS_ARM1_FORWARD ,0, Arm1_AnimProgress_Fwd);
        }

        if (Input.GetKey(KeyCode.S))
        {
            animator.SetFloat("SpeedMult0", 1);
            CustomAnimationUtility.ChangeAnimatorState(animator, ANIMS_ARM1_BACKWARD, 0, Arm1_AnimProgress_Back);
        ...
        if (Input.GetKey(KeyCode.Q))
        {
            ...
            CustomAnimationUtility.ChangeAnimatorState(animator, ANIMS_ARM3_FORWARD, 1, Arm3_AnimProgress_Fwd);
        }

        if (Input.GetKey(KeyCode.E))
        {
            animator.SetFloat("SpeedMult1", 1);
            CustomAnimationUtility.ChangeAnimatorState(animator, ANIMS_ARM3_BACKWARD, 1, Arm3_AnimProgress_Back);
